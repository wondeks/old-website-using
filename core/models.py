...
class Vendor(models.Model):
    ...
    title = models.CharField(max_length=100, default="Kebebew")
...
class Product(models.Model):
    ...
    title = models.CharField(max_length=100, default="Give Option")
    image = models.ImageField(upload_to=user_directory_path, default="product.jpg")
    # description = models.TextField(null=True, blank=True, default="This is the product")
    description = RichTextUploadingField(null=True, blank=True, default="This is the product")

    price = models.DecimalField(max_digits=99999999999999, decimal_places=2, default="200.00")
    old_price = models.DecimalField(max_digits=99999999999999, decimal_places=2, default="200.00")

    specifications = RichTextUploadingField(null=True, blank=True)
    # specifications = models.TextField(null=True, blank=True)
    type = models.CharField(max_length=100, default="permier league", null=True, blank=True)
    stock_count = models.CharField(max_length=100, default="1", null=True, blank=True)
    life = models.CharField(max_length=100, default="1 Days", null=True, blank=True)
